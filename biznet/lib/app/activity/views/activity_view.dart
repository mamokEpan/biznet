...
class ActivityFormView extends GetView<ActivityFormController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          controller.currentActivity.value == null
              ? "Tambah Aktivitas"
              : "Edit Aktivitas",
        ),
          ...
          children: [
            ...
            Obx(
              () => _buildDateTimePicker(
                ...
                onTap: () =>
                    controller.pickDateTime(context, isStartTime: true),
              ),
            ),
            const SizedBox(height: 16),
            Obx(
              () => _buildDateTimePicker(
                ...
                onTap: () =>
                    controller.pickDateTime(context, isStartTime: false),
              ),
            ),
            const SizedBox(height: 16),
            Obx(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: BiznetColors.primaryBlue.withOpacity(0.5),
          ),
        ),
