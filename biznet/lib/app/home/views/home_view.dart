import 'package:biznet/app/home/controllers/home_controller.dart';
import 'package:biznet/utils/const.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          ...
          style: TextStyle(color: BiznetColors.light),
        ),
        backgroundColor: BiznetColors.primaryBlue,
        centerTitle: true,
        leading: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/icons/logo2.png', height: 40),
        ),
      ),
      body: Obx(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInfoRow(Icons.location_on, activity.lokasi),
                          _buildInfoRow(
                            Icons.timer,
                              ...
                              children: [
                                if (activity.status != 'Selesai')
                                  IconButton(
                                    icon: const Icon(
                                      Icons.check_circle,
                                      color: BiznetColors.successGreen,
                                    ),
                                ...
                                IconButton(
                                  icon: const Icon(
                                    Icons.edit,
                                    color: BiznetColors.primaryBlue,
                                  ),
                                  tooltip: 'Edit',
                                  onPressed: () => controller
                                      .navigateToEditActivity(activity),
                                ),
                                IconButton(
                                  icon: const Icon(
                                    Icons.delete,
                                    color: BiznetColors.dangerRed,
                                  ),
                                  tooltip: 'Hapus',
                                  onPressed: () =>
